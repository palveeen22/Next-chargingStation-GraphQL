...
const DownloadButtons = () => {
    return (
        <div className="flex-col md:flex-row lg:flex justify-center items-center md:gap-8 my-10">
            <Link href="https://play.google.com/store/apps/details?id=id.voltron">
                <button
                    type="button"
            ...
            <Link href="https://apps.apple.com/us/app/voltron/id6448490407">
                <button
                    type="button"
